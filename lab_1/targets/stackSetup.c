/*
        ...
        Please send any bug reports to Courtney Gibson
...
int main(const int argc, const char *argv[]) {
  ...
  mmap_result = mmap(targetStack, (stackSize + pageSize),
                     ...
                     MAP_ANON | MAP_FIXED | MAP_PRIVATE, -1, (off_t)0);
  ...
  assert(rc == 0);
  rc = pthread_create(&lab_main_thread_id, &pthread_attr, lab_main_thread,
                      (void *)&args);
  assert(rc == 0);
